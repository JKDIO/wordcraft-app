...
> **현재 상태 스탬프 → 라이브 v1.4.26 · 소스 v1.4.26 (2026-08-14). ★월드 7~10 개방 완료★**
>
...
> ⚠️ 소스 SSOT = 노트북 `_dev_github/src_v1.4.26/`(+ tgz). 콘텐츠 SSOT = `wordcraft_content_v1.4.26.json`(+ 월드7~10 원본 `wordcraft_content_w710_src_v1.4.24.tgz`). 어휘 SSOT = `wordcraft_vocab_v1.4.20.json`. 계약 = `연동계약_CONTRACT_v1.7.md`.

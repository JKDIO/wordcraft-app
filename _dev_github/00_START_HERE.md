...
> **현재 상태 스탬프 → 라이브 v1.4.28 · 소스 v1.4.28 (2026-08-14). ★월드 7~10 개방 + ⚔️ 룬 장비창★**
>
...
> ⚠️ 소스 SSOT = 노트북 `_dev_github/src_v1.4.28/`(+ tgz). 콘텐츠 SSOT = `wordcraft_content_v1.4.26.json`(v1.4.27~28은 코드만 변경)(+ 월드7~10 원본 `wordcraft_content_w710_src_v1.4.24.tgz`). 어휘 SSOT = `wordcraft_vocab_v1.4.20.json`. 계약 = `연동계약_CONTRACT_v1.7.md`.

## ⚡ 지금 최우선 (2026-08-14~)
1. **★예한이 실기기(A24) 확인★** — 월드 7~10이 열렸다. ① 새 월드 4개가 폰에서 보이는가 ② P1 첫 팩에서 소리가 나는가 ③ 🔮 문장 소환이 손에 맞는가 ④ 15~20분에 몇 스텝을 하는가. **이게 최종 판정이다.**

 ...
 *   · 세션 244는 `duration_seconds` **37,027초(10시간 17분)** — 아빠 PC에 탭이 열린 채 밤을 새운 것이다.
 ...
 *   · **데스크탑 = 구경 모드**(읽기 전용). 화면 위에 띄가 뜼고, **한 번 누르면** 학습 기기로 바꿀 수 있다.
...
/** 구경 모드 때문에 막힐 쓰기 횟수 — 화면이 "여기서 한 건 기록에 안 남았어"라고 말할 근거. */
